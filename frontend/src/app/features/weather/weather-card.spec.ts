...
describe('WeatherCard', () => {
  ...
  it('render tên city, nhiệt độ hiện tại (°C mặc định), gió và nhãn thời tiết', async () => {
  ...
  it('toggle đơn vị thì nhiệt độ đổi sang °F tức thì', async () => {
    const fixture = await createFixture();
    ...
    expect(text).not.toContain('30°C');
  });
});
